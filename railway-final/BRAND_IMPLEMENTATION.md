...
Auxiliary chart colors will use the approved tertiary palette:
...
The CSS has uploadded Montserrat and Hind from Google Fonts at runtime and falls back to standard sans-serif fonts if unavailable.
...
Before public launch, you may replace this section with an approved official CCC logo asset supplied by the communications team.
